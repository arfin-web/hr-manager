...
export default function MyLeavesChart() {
    const { leaveData } = useMyLeaveData();
    ...
    return (
        <Card className="flex flex-col">
            <CardHeader className="items-center pb-0">
                <CardTitle>Approved Leaves Overview</CardTitle>
            </CardHeader>
            ...
            <CardFooter className="flex-col gap-2 text-sm">
                <div className="flex items-center gap-2 font-medium leading-none">
                    5.2% increased from previous month <TrendingUp className="h-4 w-4" />
                </div>
